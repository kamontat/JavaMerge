...
public class MergeTest {
	...
	public void testEqualsSortArray() {
		...
		Integer[] result = Merge.merge(a, b, true);
		Integer[] resultReverse = Merge.merge(a, b, false);
	...
	public void testNotEqualsSortArray() {
		...
		Integer[] result1 = Merge.merge(a, b, true);
		Integer[] result2 = Merge.merge(b, a, true);
		
		Assert.assertArrayEquals(expected, result1);
		Assert.assertArrayEquals(expected, result2);
		
		Integer[] resultReverse1 = Merge.merge(a, b, false);
		Integer[] resultReverse2 = Merge.merge(b, a, false);
